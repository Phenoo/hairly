...
export const metadata = {
  title: "FAQs | A-Glory Hair and Cosmetics",
  description: "Answers about A-Glory products, delivery, returns and store collection.",
};
...
const faqs = [
  ...
  ["Can I ask for product advice?", "Yes. Call 01322 333305 or message the A-Glory team on WhatsApp for help with products, shades, textures and routines."],
];
  ...
  return (
    <section className="route-page container section-space">
      <div className="page-kicker">
        ...
        <p>Clear answers for shopping online and visiting A-Glory in Erith.</p>
      </div>
