  ...
  return (
    <main className="site-shell">
      ...
      <header className="site-header">
        <div className="header-main container">
          ...
          <nav className="desktop-nav" aria-label="Main navigation">
            ...
            <button onClick={() => document.getElementById("edit")?.scrollIntoView({ behavior: "smooth" })}>The Aglory Edit</button>
          </nav>
      ...
      {activeView === "home" && <>
        ...
        <section className="edit-section section-space" id="edit"><div className="container edit-grid"><div className="edit-copy"><span className="eyebrow">The Aglory Edit</span><h2>Beauty wisdom<br /><em>worth keeping.</em></h2><p>Practical, culturally-aware guidance for the routines you actually live — from choosing your undertone to caring for a wig between wears.</p><button className="text-button" onClick={() => goTo("contact")}>Read the latest edit <ArrowRight size={16} /></button></div><div className="article-card"><img src={image("photo-1570194065650-d99fb4ee38df", 1000)} alt="Body care ritual" /><div className="article-card-copy"><span className="eyebrow">SKIN / 6 MIN READ</span><h3>The soft-skin ritual, decoded.</h3><p>How to build a body-care routine that feels like a moment, not a chore.</p><ArrowUpRight size={18} /></div></div><div className="article-list"><button><span>01</span><strong>How to choose your undertone</strong><ArrowRight size={15} /></button><button><span>02</span><strong>Wig care between wears</strong><ArrowRight size={15} /></button><button><span>03</span><strong>Protective styling, less stress</strong><ArrowRight size={15} /></button></div></div></section>
      ...
      <footer className="site-footer"><div className="container footer-main"><div className="footer-brand"><button className="logo" onClick={() => goTo("home")}><span>ag</span>lory</button><p>The destination for beauty that understands you.</p><div className="socials"><a href="https://www.instagram.com" aria-label="Instagram">◎</a><a href="https://www.whatsapp.com" aria-label="WhatsApp">◌</a><a href="https://www.tiktok.com" aria-label="TikTok">♪</a></div></div><div className="footer-col"><span>Shop</span><button onClick={() => goTo("shop")}>Hair care</button><button onClick={() => goTo("shop")}>Wigs & extensions</button><button onClick={() => goTo("shop")}>Skin & body</button><button onClick={() => goTo("shop")}>New arrivals</button><button onClick={() => goTo("shop")}>Best sellers</button></div><div className="footer-col"><span>Help</span><button onClick={() => goTo("contact")}>Contact</button><button onClick={() => goTo("contact")}>Delivery & returns</button><button onClick={() => goTo("account")}>Track an order</button><button onClick={() => goTo("account")}>Your account</button><button onClick={() => goTo("brands")}>Brands</button></div><div className="footer-col footer-visit"><span>Visit us</span><p>Aglory Hair & Cosmetics<br />8 Cross Street<br />Erith, Kent DA8 1RB</p><a href="tel:01322333305">01322 333305</a><a href="mailto:info@agloryhairandcosmetics.co.uk">info@agloryhairandcosmetics.co.uk</a></div></div><div className="container footer-bottom"><span>© 2026 Aglory Hair & Cosmetics</span><span>Beauty, culture, confidence.</span><span>Privacy &nbsp; Terms</span></div></footer>

      <a className="whatsapp-float" href="https://wa.me/4407446841404" target="_blank" rel="noreferrer" aria-label="Chat with Aglory on WhatsApp"><span>◌</span><small>Need beauty advice?</small></a>
