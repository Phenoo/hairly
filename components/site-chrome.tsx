...
function SiteFooter() {
  return <><section className="newsletter"><div className="container newsletter-inner"><div><span className="eyebrow">A little beauty in your inbox</span><h2>Your beauty inbox,<br /><em>upgraded.</em></h2></div><div><p>New arrivals, expert advice and members-only offers — considered, never noisy.</p><form className="newsletter-form" onSubmit={(event) => event.preventDefault()}><input type="email" placeholder="Your email address" aria-label="Your email address" required /><button type="submit">Join the community <span>→</span></button></form><small>By subscribing, you agree to receive Aglory updates. Unsubscribe anytime.</small></div></div></section><footer className="site-footer"><div className="container footer-main"><div className="footer-brand"><Link className="logo" href="/"><span>ag</span>lory</Link><p>The destination for beauty that understands you.</p><div className="socials"><a href="https://www.instagram.com" aria-label="Instagram"><FaInstagram /></a><a href="https://wa.me/4407446841404" aria-label="WhatsApp"><FaWhatsapp /></a><a href="https://www.tiktok.com" aria-label="TikTok"><FaTiktok /></a><a href="https://www.facebook.com" aria-label="Facebook"><FaFacebookF /></a></div></div><div className="footer-col"><span>Shop</span><Link href="/shop">Hair care</Link><Link href="/category/wigs-extensions">Wigs & extensions</Link><Link href="/category/skin-body">Skin & body</Link><Link href="/shop?collection=new-arrivals">New arrivals</Link><Link href="/shop?collection=best-sellers">Best sellers</Link></div><div className="footer-col"><span>Help</span><Link href="/contact">Contact</Link><Link href="/policies/delivery-returns">Delivery & returns</Link><Link href="/track-order">Track an order</Link><Link href="/account">Your account</Link><Link href="/brands">Brands</Link></div><div className="footer-col footer-visit"><span>Visit us</span><p>Aglory Hair & Cosmetics<br />8 Cross Street<br />Erith, Kent DA8 1RB</p><a href="tel:01322333305">01322 333305</a><a href="mailto:info@agloryhairandcosmetics.co.uk">info@agloryhairandcosmetics.co.uk</a></div></div><div className="container footer-bottom"><span>© 2026 Aglory Hair & Cosmetics</span><span>Beauty, culture, confidence.</span><span>Privacy · Terms</span></div></footer><a className="whatsapp-float" href="https://wa.me/4407446841404" target="_blank" rel="noreferrer" aria-label="Chat with Aglory on WhatsApp"><span><FaWhatsapp size={18} /></span><small>Need beauty advice?</small></a></>;
}
